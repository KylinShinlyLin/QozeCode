...
作为开发者的智能副驾驶，QozeCode 不仅提供代码生成与审查能力，更能直接与系统 Shell 交互，执行文件操作、系统管理及网络检索，所有操作均在现代化的 TUI（终端用户界面）中实时呈现。
...
| **Zhipu AI**      | `GLM-4.6` / `GLM-5` / `GLM-5V Turbo`        | 优秀的中文理解能力，GLM-5V 支持多模态视觉      |
