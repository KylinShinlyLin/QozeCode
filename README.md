...
- 🧩 **技能系统**: 可扩展的领域专家插件架构
- 🔌 **多模型支持**: 集成 8+ 主流 LLM 厂商，支持 LiteLLM 自定义端点
...
|:------------------|:----------------------------------------|:---------------------------------|
| **OpenAI**        | `GPT-5.4`                               | 强大的通用推理与代码生成能力                   |
| **DeepSeek**      | `DeepSeek V4 Pro` / `DeepSeek V4 Flash` | 最新 DeepSeek V4 系列，卓越推理性能与高性价比    |
| **Google**        | `Gemini 3.1 Pro` / `Gemini 3 Flash`     | 谷歌最新多模态模型，通过 Vertex AI 接入        |
| **xAI**           | `Grok 4.1 Fast`                         | 极速推理，专注于实时信息处理                   |
| **Zhipu AI**      | `GLM-5` / `GLM-5V Turbo`                | 优秀的中文理解能力，GLM-5V 支持多模态视觉         |
| **Alibaba Cloud** | `Qwen3 Max` / `Qwen3.6 Plus`            | 通义千问最新旗舰，支持深度思考模式                |
| **Moonshot**      | `Kimi K2.5` / `Kimi for Coding`         | 月之暗面双模型：K2.5 通用能力强，Coding 专为编程优化 |
| **LiteLLM**       | `GPT-5.4` / 任意兼容 OpenAI API 的模型         | 支持自定义 API 端点，灵活接入任意模型            |
