...
class SkillManager:
    ...
    def list_skills(self, show_all: bool = False):
        ...
        for name, skill in self.skills.items():
            ...
            table.add_row(name, skill.tier, status, skill.description[:60] + "..." if len(skill.description) > 60 else skill.description)
    ...
    def refresh_skills(self):
        """刷新技能列表"""
        self._discover_skills()
        console.print("[green]✅ Skills refreshed successfully![/green]")
